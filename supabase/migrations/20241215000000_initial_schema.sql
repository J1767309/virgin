...
-- Hotels: Allow service role full access for seeding
CREATE POLICY "Service role has full access to hotels" ON hotels
...
-- STR Data: Service role full access
CREATE POLICY "Service role has full access to str_data" ON str_data
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to web_analytics" ON web_analytics_data
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to paid_media" ON paid_media_data
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to annual_strategies" ON annual_strategies
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to quarterly_strategies" ON quarterly_strategies
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to tactics" ON tactics
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to weekly_updates" ON weekly_updates
    FOR ALL TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY "Service role has full access to user_hotel_assignments" ON user_hotel_assignments
    FOR ALL TO service_role USING (true) WITH CHECK (true);
